  ...
  return (
    <div className='flex items-center justify-between py-4' >
        ...
        <div>
            {  
                user ?
                //user details name profile etc
                <div className='flex items-center gap-2 sm:gap-3' >
                    <button onClick={()=>navigate('/')} className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700' >
                        <img src={assets.credit_star} alt="" className='w-5' />
                        <p className='text-xs sm:text-sm font-medium text-gray-600' >Credits left : 50</p>
                    </button>
                    <p className='text-gray-600 max-sm:hidden pl-4' >Hi, Hardik</p>
                ...
                //login button if the user is logged out 
